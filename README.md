...
2. **IMPORTANT**: Click this link ([Regression Challenge Sign Up](https://www.kaggle.com/t/2e03788f7c184663932ea7a62fa1c737)) to **join** the competition (otherwise you will not be able to make submissions!)
3. Review the material on the [DSIR-919 Regression Challenge](https://www.kaggle.com/competitions/dsir-919-project-2/overview)
...
Materials must be submitted by the beginning of class on **Friday, October 14th**.

The last day for the Kaggle competition will be **Friday, October 14th**.
...
- **Must be within time limit established by instructor.**
